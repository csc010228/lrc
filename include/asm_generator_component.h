...
enum class event_type
{
    ...
    GET_ALL_CONTEXT_SAVED_CPU_REGS,
    GET_ALL_CONTEXT_SAVED_VFP_REGS, 
    ...
    CLEAR_CURRENT_BASIC_BLOCK_STACK,
    ...
    WRITE_CONST_TO_REG,
    PUSH_VAR_TO_STACK,
    //DISABLE_ALL_ADDR_REGS_RELATED_WITH_SP,
    ...
    GET_VAR_CARED_FLAG,
    POP_STACK_WHEN_EXIT_BASIC_BLOCK,
    ...
    GET_ARRAY_S_ALL_MEMBERS_IN_CURRENT_FUNC,
    GET_ARRAY_MEMBERS_WITH_SPECIFIED_OFFSET,
    GET_CURRENT_FUNC_S_F_PARAMS,
    INEFFECTIVE_CONST_VALUE_ANALYSIS,
    INEFFECTIVE_VALUE_ANALYSIS,
    INEFFECTIVE_NOT_ARRAY_GLOBAL_ADDR_ANALYSIS,
    DIRTY_VALUE_ANALYSIS,
    GET_BASIC_BLOCK_ENTER_S_INEFFECTIVE_CONST_VALUE_ANALYSIS_INFO,
    GET_BASIC_BLOCK_ENTER_S_INEFFECTIVE_VALUE_ANALYSIS_INFO,
    GET_BASIC_BLOCK_ENTER_S_INEFFECTIVE_NOT_ARRAY_GLOBAL_ADDR_ANALYSIS_INFO,
    GET_BASIC_BLOCK_ENTER_S_DIRTY_VALUE_ANALYSIS_INFO,
    GET_CURRENT_BASIC_BLOCK_EXIT_S_DIRTY_VALUE_ANALYSIS_INFO,
    GET_FUNC_S_F_PARAMS_IN_REGS,
    IS_FUNC_S_ANY_F_PARAMS_IN_MEMORY,
    GET_CPU_REGS_HOLDING_F_PARAMS_WHEN_ENTERING_FUNC,
    GET_VFP_REGS_HOLDING_F_PARAMS_WHEN_ENTERING_FUNC,
    IS_A_START_BASIC_BLOCK,
    GET_CURRENT_BASIC_BLOCK,
    GET_VIRTUAL_TRAGET_CODE_OF_CURRENT_FUNC,
    DEAL_WITH_PARMAS_IN_ARGUMENT_REGS,
    RECORD_STACK_SPACE_CHANGED_HERE,
    SET_STACK_SPACE,
    START_GENERATING_SPILLING_VIRTUAL_CODES,
    GET_SPILLING_VIRTUAL_CODES,
    GET_REG_BY_NAME,
    IS_AN_ABI_FUNC,
    GET_AN_ABI_FUNC_S_PARAM_REGS,
    IS_REG_EFFECTIVE,
